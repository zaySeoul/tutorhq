...
class SubscriptionsPaymentView extends React.Component {
  ...
  render() {
    return (
      <div>
        <Container>
          <h2>TutorHQ Premium</h2>
          <p>
            A credit card is required to start your free trial. After your trial
            ends, your card will be charged $4.99 a month. Don't worry, you can
            cancel your subscription at any time during the trial.
          </p>
...
export default SubscriptionsPaymentView;
